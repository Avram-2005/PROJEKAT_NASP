...
func TestInitialize(t *testing.T) {
	...
	if config.WriteAheadLogConfig.SegmentSize != 16 || config.WriteAheadLogConfig.FilePath != "./TestDataBase/walDATA" {
...
func TestInitializeDefualt(t *testing.T) {
	...
	if config.WriteAheadLogConfig.SegmentSize != 16 || config.WriteAheadLogConfig.FilePath != "../DataBase/walDATA" {
		fmt.Print("Wrong WAL configuration")
		fmt.Print(config.WriteAheadLogConfig)
		t.FailNow()
	}
